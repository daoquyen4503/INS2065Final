...
ActiveRecord::Schema[7.0].define(version: 2023_12_23_163316) do
  ...
  create_table "shipment_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_shipment_details_on_book_id"
  ...
  add_foreign_key "shipment_details", "books"
