...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference("Shipment.count") do
      post shipments_url, params: { shipment: { received_at: @shipment.received_at, staff_id: @shipment.staff_id, supplier_id: @shipment.supplier_id } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { received_at: @shipment.received_at, staff_id: @shipment.staff_id, supplier_id: @shipment.supplier_id } }
