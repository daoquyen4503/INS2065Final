...
class ShipmentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment_detail" do
    assert_difference("ShipmentDetail.count") do
      post shipment_details_url, params: { shipment_detail: { book_id: @shipment_detail.book_id, quantity: @shipment_detail.quantity, shipment_id: @shipment_detail.shipment_id } }
    end
  ...
  test "should update shipment_detail" do
    patch shipment_detail_url(@shipment_detail), params: { shipment_detail: { book_id: @shipment_detail.book_id, quantity: @shipment_detail.quantity, shipment_id: @shipment_detail.shipment_id } }
